"""
Test Lambda function handler for Fullbay API integration testing.
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    """
    Test Lambda function handler for Fullbay API integration.
    ...
    try:
        ...
        if api_data:
            ...
            logger.info(f"📋 Sample invoice keys: {list(sample_invoice.keys())[:10]}...")
        ...
        response = create_response(
            ...
            api_status=api_status,
            token_generated=True,
            sample_invoice_keys=list(sample_invoice.keys())[:10] if api_data else []
        )
