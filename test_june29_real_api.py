#!/usr/bin/env python3
"""
End-to-End Test: June 29th, 2025
Test the complete pipeline with real Fullbay API data for June 29th.
"""
...
def main():
    """Main function to test June 29th data processing."""
    print("🚀 End-to-End Test: June 29th, 2025")
    print("=" * 50)
    print(f"📅 Fetching data for 2025-06-29...")
    ...
    try:
        ...
        if invoices:
            ...
            filename = f"real_api_response_june29_{target_date.replace('-', '')}.json"
