#!/usr/bin/env python3
"""
End-to-End Test: June 28th, 2025
Test the complete pipeline with real Fullbay API data for June 28th.
"""
...
def main():
    """Main function to test June 28th data processing."""
    print("🚀 End-to-End Test: June 28th, 2025")
    print("=" * 50)
    print(f"📅 Fetching data for 2025-06-28...")
    ...
    try:
        ...
        if invoices:
            ...
            filename = f"real_api_response_june28_{target_date.replace('-', '')}.json"
