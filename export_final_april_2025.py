#!/usr/bin/env python3
"""
Export final April 2025 data to CSV with original 84-column structure
"""
...
def export_final_april_2025():
    """Export final April 2025 data to CSV."""
    print("EXPORTING FINAL APRIL 2025 DATA")
    print("=" * 50)
    ...
    try:
        ...
        # Get all line items for April 2025
        cursor.execute("""
        ...
        filename = f"april_2025_final_complete_{timestamp}.csv"
